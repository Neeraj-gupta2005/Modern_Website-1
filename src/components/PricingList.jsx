...
const PricingList = () => {
  return (
    <div className="flex gap-[1rem] items-end max-lg:flex-wrap ">
      {pricing.map((item) => (
        <div
          key={item.id}
        ...
        >
          ...
          <Button className="w-full mb-6" href = {item.price ? '/pricing ' : 'mailto:neerajKgupta33@gmail.com'}
          white = {!!item.price}
          >
          ...
          <ul>
            {item.features.map((feature, index) => (
                <li key={index} className="flex items-start py-5 border-t norder-n-6">
