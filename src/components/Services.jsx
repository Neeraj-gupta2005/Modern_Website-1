    ...
    <Section id="how-to-use" >
      <div className="container">
        ...
        <div className="relative ">
          <div
            className="relative z-1 flex items-center h-[39rem] mb-5 p-8  border overflow-hidden rounded-3xl border-n-1/10 lg:p-20 xl:h-[46rem]
              "
          >
            {/* image in box 1 */}
                  ...
                  {brainwaveServicesIcons.map((item, index) => (
                    <li
                      ...
                      className={`rounded-2xl flex items-center justify-center ${
                        index === 2
                          ? "w-[2.7rem] h-[2.7rem] bg-conic-gradient rounded-2xl md:w-[4rem] md:h-[4rem]"
                    ...
                    >
                      <div
                        className={
                          index === 2
                            ? "flex items-center justify-center w-10 h-10 bg-n-6 md:w-15 md:h-15 rounded-2xl "
                            : ""
                        }
                      >
